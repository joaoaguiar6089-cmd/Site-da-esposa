                        ...
                        <div className="relative order-2 lg:order-1 flex justify-center lg:justify-end">
                          ...
                          >
                            ...
                            <img
                              ...
                              alt={promotion.title}
                              className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.01] z-0"
                              loading="lazy"
                              decoding="async"
                              sizes="(max-width: 768px) 92vw, (max-width: 1280px) 520px, 560px"
                            />

                            {/* vinheta leve para legibilidade quando houver textos na arte */}
